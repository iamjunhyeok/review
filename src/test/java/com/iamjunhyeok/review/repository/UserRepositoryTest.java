...
class UserRepositoryTest {
    ...
    void findByEmail_유효한테스트_찾기성공() {
        userRepository.save(User.createUser("jeonjhyeok@gmail.com", "1234"));
        userRepository.save(User.createUser("jeonjhyeok2@gmail.com", "12345"));
        userRepository.save(User.createUser("jeonjhyeok3@gmail.com", "123456"));
